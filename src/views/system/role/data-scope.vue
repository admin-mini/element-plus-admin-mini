      ...
      <admin-space cols="1">
        ...
        <el-form-item label="菜单权限" v-if="postData.dataScope == 2">
          <div style="width: 100%">
            ...
            <el-checkbox v-model="nodeAll" @change="handleCheckedTreeNodeAll()">
              全选/全不选
            </el-checkbox>
...
const submitForm = (formEl) => {
  formEl.validate((valid) => {
    if (valid) {
      dataScope({ ...postData.value, deptIds: getAllCheckedKeys() })
        .then((res) => {
