import{r as m,c as t,o as v,d as _,e as a,f as s,g as u,t as o,h as y}from"./index-77378a01.js";const b={class:"admin-view"},f={class:"admin-view-header"},w={class:"admin-view-body"},h={style:{display:"block","white-space":"pre-wrap",background:"var(--el-color-black)",color:"var(--el-color-white)","margin-top":"30px",padding:"20px"}},V={__name:"index",setup(g){const e=m({});let i=`<template>
